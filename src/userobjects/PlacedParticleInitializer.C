...
#include "PlacedParticleInitializer.h"

registerMooseObject("FenixApp", PlacedParticleInitializer);

InputParameters
PlacedParticleInitializer::validParams()
{
...
PlacedParticleInitializer::PlacedParticleInitializer(const InputParameters & parameters)
...
PlacedParticleInitializer::getParticleData() const
{
