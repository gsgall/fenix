...
#include "PlacedInitializer.h"

registerMooseObject("FenixApp", PlacedInitializer);

InputParameters
PlacedInitializer::validParams()
{
...
PlacedInitializer::PlacedInitializer(const InputParameters & parameters)
...
PlacedInitializer::getParticleData() const
{
