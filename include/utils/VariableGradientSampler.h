 ...
 */
class VariableGradientSampler
{
public:
  VariableGradientSampler(FEProblemBase & problem, const VariableName & name, const THREAD_ID tid);
   ...
   */
  Point sampleGradient(const Point & point, const Elem * element) const;
